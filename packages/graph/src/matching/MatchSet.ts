 ...
 * @param {number} score
 */
function findInsertLocation(matches: Match<any>[], score: number) {
...
export interface MatchSetOptions {
 ...
 * highest score.
 */
export class MatchSet<V> {
	private matches: Match<V>[];
	private isEqual: (a: any, b: any) => boolean;

	public constructor(options: MatchSetOptions = {}) {
		this.matches = [];
		this.isEqual = options.isEqual || deepEqual;
	}

/*
 * Generate `src/tokenization/matchers.ts` from the Unicode character
 * databases. Run as part of the build, so the generated file always matches
 * the data currently installed.
 */
...
writeFileSync(join(here, '..', 'src', 'tokenization', 'matchers.ts'), source);
